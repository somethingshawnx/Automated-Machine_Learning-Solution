...
# --- UPDATED IMPORT ---
from src.ui.ai_assistant import show_ai_assistant_page 

warnings.filterwarnings('ignore')

st.set_page_config(
    page_title="MachineLearning Studio",
    page_icon="🤖",
    layout="wide"
)
...
st.title("🤖 MachineLearning Studio") 
st.write("Upload, explore, preprocess, train, and evaluate models—all in one place.")

selected_tab = option_menu(
    menu_title=None,
    # --- RENAMED "Chatbot" to "AI Assistant" ---
    options=["Upload", "Explore", "Preprocess", "Train", "Evaluate", "Insights", "AI Assistant"],
